...
class ApocalypseEasy {
	...
	int maximalSurvival(vector <int> p, vector <int> position, int t) {
		...
		FOR(i,t) {
			...
			FOR(j,N) mf.add_edge(st+j,st+50+j,1), mf.add_edge(st+50+j,st+100+j,100);
		}
...
// BEGIN CUT HERE
	...
	void test_case_4() { int Arr0[] = {0,0,0,0,0}; vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arr1[] = {0,1,2}; vector <int> Arg1(Arr1, Arr1 + (sizeof(Arr1) / sizeof(Arr1[0]))); int Arg2 = 2; int Arg3 = 3; verify_case(4, Arg3, maximalSurvival(Arg0, Arg1, Arg2)); }
	void test_case_5() { int Arr0[] = {0}; vector <int> Arg0(Arr0, Arr0 + (sizeof(Arr0) / sizeof(Arr0[0]))); int Arr1[] = {0,1}; vector <int> Arg1(Arr1, Arr1 + (sizeof(Arr1) / sizeof(Arr1[0]))); int Arg2 = 1; int Arg3 = 0; verify_case(5, Arg3, maximalSurvival(Arg0, Arg1, Arg2)); }
